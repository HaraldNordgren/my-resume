...
\cvitem{Description}{I did research for Ericsson on adaptive streaming in the HEVC/H.265 video coding standard. We developed two methods for transcoding video at much-reduced complexity that save up to 30\% storage space under certain conditions. I wrote my own test suite for running heavy simulations in a cluster environment and for structuring large amounts of data in Excel. I used Python, C/C\texttt{++} and Shell scripts on a day-to-day basis.}
...
\cvitemwithcomment{English}{Fluent}{I went to school in the United States for\\a year, lived with a group of American\\roommates and spoke English every day}
